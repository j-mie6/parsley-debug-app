...
pub struct DebugNode {
    ...
    pub child_id: usize, /* The unique child number of this node */
    pub input: String, /* The input string passed to the parser */
    pub children: Vec<DebugNode>, /* The children of this node */
}

impl DebugNode {
    pub fn new(name: String, internal: String, success: bool, child_id: usize, input: String, children: Vec<DebugNode>) -> Self {
        DebugNode {
            name,
            internal,
            success,
